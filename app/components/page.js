...
import { notoSans, poppins } from "./fonts";
...
const Player = () => {
  ...
  return (
    <div className="bg-mahogany-800 flex justify-stretch items-center mt-16 h-[60px] px-5">
      <div className="flex">
        <div>
          <svg
            fill="black"
        ...
        {isPlaying.current ? (
          <div className="flex items-center">
            <Image
              ...
              alt={`${currentTrackData.trackAlbum} album cover`}
            />
            <div>
              <p className={`${notoSans.className} font-semibold`}>
