          ...
          <div className="flex justify-center mt-24 mx-96 p-6 rounded-2xl">
            <div className="flex-col items-center min-w-[450px]">
              <div className="flex items-center mt-32">
                ...
                >
                  To begin tracking your data, Mozart needs access to your
                  Spotify account. Upon clicking the button, you will be
                  redirected to the Spotify authorization page.
                </span>
              </div>
            ...
            <div className="flex justify-center items-center w-[300px] min-w-[200px] h-[400px] min-h-[300px]">
